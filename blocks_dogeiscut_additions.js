...
Object.assign(blocks.processedBlocks, {
  ...
  dogeiscutObject_set: [[{ name: 'OBJECT', type: 1 }, { name: 'KEY', type: 1 }, { name: 'VALUE', type: 1 }], 'reporter'],
  dogeiscutObject_setPath: [[{ name: 'OBJECT', type: 1 }, { name: 'ARRAY', type: 1 }, { name: 'VALUE', type: 1 }], 'reporter'],
