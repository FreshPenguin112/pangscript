...
(() => {
  ...
  t.r(e), t.d(e, {
    ATN: () => $,
    ATNDeserializer: () => Lt,
    BailErrorStrategy: () => Ce,
    CharStream: () => Ie,
    CharStreams: () => ve,
    CommonToken: () => Pt,
    CommonTokenStream: () => be,
    DFA: () => le,
    DefaultErrorStrategy: () => Ae,
    DiagnosticErrorListener: () => me,
    ErrorListener: () => Ot,
    FailedPredicateException: () => Te,
    FileStream: () => Oe,
    InputStream: () => Ie,
    Interval: () => m,
    IntervalSet: () => E,
    ...
    NoViableAltException: () => ee,
    ParseTreeListener: () => de,
    ParseTreeVisitor: () => pe,
    ParseTreeWalker: () => ge,
    Parser: () => Fe,
    ParserATNSimulator: () => se,
    ParserRuleContext: () => Be,
    PredictionContextCache: () => ie,
    PredictionMode: () => te,
    RecognitionException: () => Ft,
    RuleContext: () => M,
    RuleNode: () => w,
    TerminalNode: () => P,
    Token: () => n,
  ...
  function r(t) {
    if (!t) return 0;
    const e = typeof t,
      n = "string" === e ? t : !("object" !== e || !t.toString) && t.toString();
    if (!n) return 0;
    let s, r;
    const o = 3 & n.length,
      a = n.length - o;
    ...
    const h = 3432918353,
      c = 461845907;
    let u = 0;
    for (; u < a;) r = 255 & n.charCodeAt(u) | (255 & n.charCodeAt(++u)) << 8 | (255 & n.charCodeAt(++u)) << 16 | (255 & n.charCodeAt(++u)) << 24, ++u, r = (65535 & r) * h + (((r >>> 16) * h & 65535) << 16) & 4294967295, r = r << 15 | r >>> 17, r = (65535 & r) * c + (((r >>> 16) * c & 65535) << 16) & 4294967295, l ^= r, l = l << 13 | l >>> 19, s = 5 * (65535 & l) + ((5 * (l >>> 16) & 65535) << 16) & 4294967295, l = 27492 + (65535 & s) + ((58964 + (s >>> 16) & 65535) << 16);
    switch (r = 0, o) {
      case 3:
        r ^= (255 & n.charCodeAt(u + 2)) << 16;
      case 2:
        r ^= (255 & n.charCodeAt(u + 1)) << 8;
      case 1:
        r ^= 255 & n.charCodeAt(u), r = (65535 & r) * h + (((r >>> 16) * h & 65535) << 16) & 4294967295, r = r << 15 | r >>> 17, r = (65535 & r) * c + (((r >>> 16) * c & 65535) << 16) & 4294967295, l ^= r;
    }
    return l ^= n.length, l ^= l >>> 16, l = 2246822507 * (65535 & l) + ((2246822507 * (l >>> 16) & 65535) << 16) & 4294967295, l ^= l >>> 13, l = 3266489909 * (65535 & l) + ((3266489909 * (l >>> 16) & 65535) << 16) & 4294967295, l ^= l >>> 16, l >>> 0;
  }
  class o {
    constructor() {
    ...
    update() {
      for (let t = 0; t < arguments.length; t++) {
        const e = arguments[t];
        if (null != e) if (Array.isArray(e)) this.update.apply(this, e);else {
          let t = 0;
          switch (typeof e) {
            case "undefined":
            case "function":
  ...
  function a(t) {
    return t ? "string" == typeof t ? r(t) : t.hashCode() : -1;
  }
  function l(t, e) {
  ...
  function c(t) {
    return Array.isArray(t) ? "[" + t.map(h).join(", ") + "]" : "null";
  }
  const u = "h-";
  class d {
    constructor(t, e) {
      this.data = {}, this.hashFunction = t || a, this.equalsFunction = e || l;
    }
    add(t) {
      const e = u + this.hashFunction(t);
      if (e in this.data) {
        const n = this.data[e];
    ...
    values() {
      return Object.keys(this.data).filter(t => t.startsWith(u)).flatMap(t => this.data[t], this);
    }
    toString() {
      return c(this.values());
    }
    get length() {
      return Object.keys(this.data).filter(t => t.startsWith(u)).map(t => this.data[t].length, this).reduce((t, e) => t + e, 0);
    }
  }
  class p {
    hashCode() {
    ...
    static andContext(t, e) {
      if (null === t || t === p.NONE) return e;
      if (null === e || e === p.NONE) return t;
      const n = new g(t, e);
    ...
    static orContext(t, e) {
      if (null === t) return e;
      if (null === e) return t;
      if (t === p.NONE || e === p.NONE) return p.NONE;
      const n = new f(t, e);
      return 1 === n.opnds.length ? n.opnds[0] : n;
    }
  }
  class g extends p {
    constructor(t, e) {
      super();
      const n = new d();
      t instanceof g ? t.opnds.map(function (t) {
        n.add(t);
      }) : n.add(t), e instanceof g ? e.opnds.map(function (t) {
        n.add(t);
      }) : n.add(e);
      const s = x(n);
      if (s.length > 0) {
    ...
    equals(t) {
      return this === t || t instanceof g && s(this.opnds, t.opnds);
    }
    updateHashCode(t) {
    ...
    evalPrecedence(t, e) {
      ...
      for (let i = 0; i < this.opnds.length; i++) {
        const r = this.opnds[i],
          o = r.evalPrecedence(t, e);
        if (n |= o !== r, null === o) return null;
        o !== p.NONE && s.push(o);
      }
      if (!n) return this;
      if (0 === s.length) return p.NONE;
      let i = null;
      return s.map(function (t) {
        i = null === i ? t : p.andContext(i, t);
      }), i;
    }
    toString() {
  ...
  class f extends p {
    constructor(t, e) {
      super();
      const n = new d();
      t instanceof f ? t.opnds.map(function (t) {
        n.add(t);
      }) : n.add(t), e instanceof f ? e.opnds.map(function (t) {
        n.add(t);
      }) : n.add(e);
      const s = x(n);
      if (s.length > 0) {
    ...
    equals(t) {
      return this === t || t instanceof f && s(this.opnds, t.opnds);
    }
    updateHashCode(t) {
    ...
    evalPrecedence(t, e) {
      ...
      for (let i = 0; i < this.opnds.length; i++) {
        const r = this.opnds[i],
          o = r.evalPrecedence(t, e);
        if (n |= o !== r, o === p.NONE) return p.NONE;
        null !== o && s.push(o);
      }
      if (!n) return this;
  ...
  function x(t) {
    ...
    return t.values().map(function (t) {
      t instanceof p.PrecedencePredicate && e.push(t);
    }), e;
  }
  function T(t, e) {
    if (null === t) {
  ...
  class S {
    ...
    equals(t) {
      return this === t || t instanceof S && this.state.stateNumber === t.state.stateNumber && this.alt === t.alt && (null === this.context ? null === t.context : this.context.equals(t.context)) && this.semanticContext.equals(t.semanticContext) && this.precedenceFilterSuppressed === t.precedenceFilterSuppressed;
    }
    ...
    equalsForConfigSet(t) {
      return this === t || t instanceof S && this.state.stateNumber === t.state.stateNumber && this.alt === t.alt && this.semanticContext.equals(t.semanticContext);
    }
    toString() {
  ...
  class E {
    ...
    addInterval(t) {
      if (null === this.intervals) this.intervals = [], this.intervals.push(t.clone());else {
        for (let e = 0; e < this.intervals.length; e++) {
          const n = this.intervals[e];
          if (t.stop < n.start) return void this.intervals.splice(e, 0, t);
          if (t.stop === n.start) return void (this.intervals[e] = new m(t.start, n.stop));
          if (t.start <= n.stop) return this.intervals[e] = new m(Math.min(n.start, t.start), Math.max(n.stop, t.stop)), void this.reduce(e);
        }
    ...
    reduce(t) {
      if (t < this.intervals.length - 1) {
        ...
        e.stop >= n.stop ? (this.intervals.splice(t + 1, 1), this.reduce(t)) : e.stop >= n.start && (this.intervals[t] = new m(e.start, n.stop), this.intervals.splice(t + 1, 1));
      }
    }
    complement(t, e) {
      const n = new E();
      return n.addInterval(new m(t, e + 1)), null !== this.intervals && this.intervals.forEach(t => n.removeRange(t)), n;
    }
    contains(t) {
    ...
    removeRange(t) {
      if (t.start === t.stop - 1) this.removeOne(t.start);else if (null !== this.intervals) {
        let e = 0;
        for (let n = 0; n < this.intervals.length; n++) {
          ...
          if (t.start > n.start && t.stop < n.stop) {
            ...
            const s = new m(t.stop, n.stop);
            return void this.intervals.splice(e, 0, s);
          }
          t.start <= n.start && t.stop >= n.stop ? (this.intervals.splice(e, 1), e -= 1) : t.start < n.stop ? this.intervals[e] = new m(n.start, t.start) : t.stop < n.stop && (this.intervals[e] = new m(t.stop, n.stop)), e += 1;
        }
      }
    }
    removeOne(t) {
      if (null !== this.intervals) for (let e = 0; e < this.intervals.length; e++) {
        ...
        if (t === n.start) return void (this.intervals[e] = new m(n.start + 1, n.stop));
        if (t === n.stop - 1) return void (this.intervals[e] = new m(n.start, n.stop - 1));
        if (t < n.stop - 1) {
          const s = new m(n.start, t);
    ...
    toCharString() {
      ...
      for (let e = 0; e < this.intervals.length; e++) {
        ...
        s.stop === s.start + 1 ? s.start === n.EOF ? t.push("<EOF>") : t.push("'" + String.fromCharCode(s.start) + "'") : t.push("'" + String.fromCharCode(s.start) + "'..'" + String.fromCharCode(s.stop - 1) + "'");
      }
    ...
    toIndexString() {
      ...
      for (let e = 0; e < this.intervals.length; e++) {
        const s = this.intervals[e];
        s.stop === s.start + 1 ? s.start === n.EOF ? t.push("<EOF>") : t.push(s.start.toString()) : t.push(s.start.toString() + ".." + (s.stop - 1).toString());
      }
      return t.length > 1 ? "{" + t.join(", ") + "}" : t[0];
    }
    toTokenString(t, e) {
    ...
    elementName(t, e, s) {
      return s === n.EOF ? "<EOF>" : s === n.EPSILON ? "<EPSILON>" : t[s] || e[s];
    }
    get length() {
  ...
  class _ {
    constructor() {
      this.atn = null, this.stateNumber = _.INVALID_STATE_NUMBER, this.stateType = null, this.ruleIndex = 0, this.epsilonOnlyTransitions = !1, this.transitions = [], this.nextTokenWithinRule = null;
    }
    toString() {
      return this.stateNumber;
    }
    equals(t) {
      return t instanceof _ && this.stateNumber === t.stateNumber;
    }
  ...
  C.EPSILON = 1, C.RANGE = 2, C.RULE = 3, C.PREDICATE = 4, C.ATOM = 5, C.ACTION = 6, C.SET = 7, C.NOT_SET = 8, C.WILDCARD = 9, C.PRECEDENCE = 10, C.serializationNames = ["INVALID", "EPSILON", "RANGE", "RULE", "PREDICATE", "ATOM", "ACTION", "SET", "NOT_SET", "WILDCARD", "PRECEDENCE"], C.serializationTypes = {
    EpsilonTransition: C.EPSILON,
    RangeTransition: C.RANGE,
    RuleTransition: C.RULE,
    PredicateTransition: C.PREDICATE,
    AtomTransition: C.ATOM,
    ActionTransition: C.ACTION,
    SetTransition: C.SET,
    NotSetTransition: C.NOT_SET,
    WildcardTransition: C.WILDCARD,
    PrecedencePredicateTransition: C.PRECEDENCE
  };
  class N extends C {
    constructor(t, e, n, s) {
      super(t), this.ruleIndex = e, this.precedence = n, this.followState = s, this.serializationType = C.RULE, this.isEpsilon = !0;
    }
    matches(t, e, n) {
      return !1;
    }
  ...
  class y extends C {
    constructor(t, e) {
      super(t), this.serializationType = C.SET, null != e ? this.label = e : (this.label = new E(), this.label.addOne(n.INVALID_TYPE));
    }
    matches(t, e, n) {
  ...
  class I extends y {
    constructor(t, e) {
      super(t, e), this.serializationType = C.NOT_SET;
    }
    matches(t, e, n) {
  ...
  class k extends C {
    constructor(t) {
      super(t), this.serializationType = C.WILDCARD;
    }
    matches(t, e, n) {
      return t >= e && t <= n;
    }
  ...
  const D = {
      toStringTree: function (t, e, n) {
        ...
        if (0 === i) return s;
        let r = "(" + s + " ";
        i > 0 && (s = D.toStringTree(t.getChild(0), e), r = r.concat(s));
        for (let n = 1; n < i; n++) s = D.toStringTree(t.getChild(n), e), r = r.concat(" " + s);
        return r = r.concat(")"), r;
      },
      getNodeText: function (t, e, s) {
        if (e = e || null, null !== (s = s || null) && (e = s.ruleNames), null !== e) {
          if (t instanceof w) {
            const n = t.ruleContext.getAltNumber();
            return 0 != n ? e[t.ruleIndex] + ":" + n : e[t.ruleIndex];
          }
          if (t instanceof b) return t.toString();
          if (t instanceof P && null !== t.symbol) return t.symbol.text;
        }
        const i = t.getPayload();
        return i instanceof n ? i.text : t.getPayload().toString();
      },
      ...
      findAllTokenNodes: function (t, e) {
        return D.findAllNodes(t, e, !0);
      },
      findAllRuleNodes: function (t, e) {
        return D.findAllNodes(t, e, !1);
      },
      findAllNodes: function (t, e, n) {
        const s = [];
        return D._findAllNodes(t, e, n, s), s;
      },
      _findAllNodes: function (t, e, n, s) {
        n && t instanceof P ? t.symbol.type === e && s.push(t) : !n && t instanceof w && t.ruleIndex === e && s.push(t);
        for (let i = 0; i < t.getChildCount(); i++) D._findAllNodes(t.getChild(i), e, n, s);
      },
      descendants: function (t) {
        let e = [t];
        for (let n = 0; n < t.getChildCount(); n++) e = e.concat(D.descendants(t.getChild(n)));
        return e;
      }
    },
    F = D;
  class M extends w {
    ...
    toStringTree(t, e) {
      return F.toStringTree(this, t, e);
    }
    toString(t, e) {
      t = t || null, e = e || null;
      let n = this,
        s = "[";
      for (; null !== n && n !== e;) {
        if (null === t) n.isEmpty() || (s += n.invokingState);else {
          const e = n.ruleIndex;
  ...
  U.EMPTY = null, U.EMPTY_RETURN_STATE = 2147483647, U.globalNodeCount = 1, U.id = U.globalNodeCount, U.trace_atn_sim = !1;
  class B extends U {
    constructor(t, e) {
      const n = new o();
    ...
    equals(t) {
      return this === t || t instanceof B && this.hashCode() === t.hashCode() && s(this.returnStates, t.returnStates) && s(this.parents, t.parents);
    }
    toString() {
      if (this.isEmpty()) return "[]";
      {
        let t = "[";
        for (let e = 0; e < this.returnStates.length; e++) e > 0 && (t += ", "), this.returnStates[e] !== U.EMPTY_RETURN_STATE ? (t += this.returnStates[e], null !== this.parents[e] ? t = t + " " + this.parents[e] : t += "null") : t += "$";
        return t + "]";
      }
    }
    get length() {
  ...
  class V extends U {
    ...
    equals(t) {
      return this === t || t instanceof V && this.hashCode() === t.hashCode() && this.returnState === t.returnState && (null == this.parentCtx ? null == t.parentCtx : this.parentCtx.equals(t.parentCtx));
    }
    toString() {
      const t = null === this.parentCtx ? "" : this.parentCtx.toString();
      return 0 === t.length ? this.returnState === U.EMPTY_RETURN_STATE ? "$" : "" + this.returnState : this.returnState + " " + t;
    }
    get length() {
      return 1;
    }
    static create(t, e) {
      return e === U.EMPTY_RETURN_STATE && null === t ? U.EMPTY : new V(t, e);
    }
  }
  class z extends V {
    constructor() {
  ...
  class H {
    ...
    entries() {
      return Object.keys(this.data).filter(t => t.startsWith(q)).flatMap(t => this.data[t], this);
    }
    getKeys() {
    ...
    get length() {
      return Object.keys(this.data).filter(t => t.startsWith(q)).map(t => this.data[t].length, this).reduce((t, e) => t + e, 0);
    }
  }
  function K(t, e) {
    if (null == e && (e = M.EMPTY), null === e.parentCtx || e === M.EMPTY) return U.EMPTY;
    const n = K(t, e.parentCtx),
      s = t.states[e.invokingState].transitions[0];
    return V.create(n, s.followState.stateNumber);
  }
  function Y(t, e, n) {
    ...
    let o = null;
    return o = 0 === r.length ? U.EMPTY : 1 === r.length ? V.create(r[0], t.getReturnState(0)) : new B(r, t.returnStates), e.add(o), n.set(o, o), n.set(t, o), o;
  }
  function G(t, e, n, s) {
    if (t === e) return t;
    if (t instanceof V && e instanceof V) return function (t, e, n, s) {
      if (null !== s) {
        let n = s.get(t, e);
        if (null !== n) return n;
      ...
      const i = function (t, e, n) {
        if (n) {
          if (t === U.EMPTY) return U.EMPTY;
          if (e === U.EMPTY) return U.EMPTY;
        } else {
          if (t === U.EMPTY && e === U.EMPTY) return U.EMPTY;
          if (t === U.EMPTY) {
            const t = [e.returnState, U.EMPTY_RETURN_STATE],
              n = [e.parentCtx, null];
            return new B(n, t);
          }
          if (e === U.EMPTY) {
            const e = [t.returnState, U.EMPTY_RETURN_STATE],
              n = [t.parentCtx, null];
            return new B(n, e);
          }
        }
      ...
      if (t.returnState === e.returnState) {
        const i = G(t.parentCtx, e.parentCtx, n, s);
        if (i === t.parentCtx) return t;
        if (i === e.parentCtx) return e;
        const r = V.create(i, t.returnState);
      ...
      }
      {
        ...
        const i = [t.returnState, e.returnState];
        let r = [t.parentCtx, e.parentCtx];
        t.returnState > e.returnState && (i[0] = e.returnState, i[1] = t.returnState, r = [e.parentCtx, t.parentCtx]);
        const o = new B(r, i);
    ...
    return t instanceof V && (t = new B([t.getParent()], [t.returnState])), e instanceof V && (e = new B([e.getParent()], [e.returnState])), function (t, e, n, s) {
      if (null !== s) {
        let n = s.get(t, e);
        if (null !== n) return U.trace_atn_sim && console.log("mergeArrays a=" + t + ",b=" + e + " -> previous"), n;
        if (n = s.get(e, t), null !== n) return U.trace_atn_sim && console.log("mergeArrays a=" + t + ",b=" + e + " -> previous"), n;
      }
      let i = 0,
        r = 0,
        o = 0,
        a = new Array(t.returnStates.length + e.returnStates.length).fill(0),
        l = new Array(t.returnStates.length + e.returnStates.length).fill(null);
      for (; i < t.returnStates.length && r < e.returnStates.length;) {
        const h = t.parents[i],
          c = e.parents[r];
        if (t.returnStates[i] === e.returnStates[r]) {
          const e = t.returnStates[i];
          e === U.EMPTY_RETURN_STATE && null === h && null === c || null !== h && null !== c && h === c ? (l[o] = h, a[o] = e) : (l[o] = G(h, c, n, s), a[o] = e), i += 1, r += 1;
        } else t.returnStates[i] < e.returnStates[r] ? (l[o] = h, a[o] = t.returnStates[i], i += 1) : (l[o] = c, a[o] = e.returnStates[r], r += 1);
        o += 1;
      }
      if (i < t.returnStates.length) for (let e = i; e < t.returnStates.length; e++) l[o] = t.parents[e], a[o] = t.returnStates[e], o += 1;else for (let t = r; t < e.returnStates.length; t++) l[o] = e.parents[t], a[o] = e.returnStates[t], o += 1;
      if (o < l.length) {
        if (1 === o) {
          const n = V.create(l[0], a[0]);
          return null !== s && s.set(t, e, n), n;
        }
        l = l.slice(0, o), a = a.slice(0, o);
      }
      const h = new B(l, a);
      return h.equals(t) ? (null !== s && s.set(t, e, t), U.trace_atn_sim && console.log("mergeArrays a=" + t + ",b=" + e + " -> a"), t) : h.equals(e) ? (null !== s && s.set(t, e, e), U.trace_atn_sim && console.log("mergeArrays a=" + t + ",b=" + e + " -> b"), e) : (function (t) {
        const e = new H();
      ...
      }(l), null !== s && s.set(t, e, h), U.trace_atn_sim && console.log("mergeArrays a=" + t + ",b=" + e + " -> " + h), h);
    }(t, e, n, s);
  }
  class j {
    constructor() {
    ...
    equals(t) {
      return t instanceof j && s(this.data, t.data);
    }
    toString() {
  ...
  class W {
    ...
    getDecisionLookahead(t) {
      ...
      for (let s = 0; s < e; s++) {
        ...
        const e = new d(),
          i = !1;
        this._LOOK(t.transition(s).target, null, U.EMPTY, n[s], e, new j(), i, !1), (0 === n[s].length || n[s].contains(W.HIT_PRED)) && (n[s] = null);
      }
      return n;
    }
    LOOK(t, e, n) {
      ...
      return this._LOOK(t, e, i, s, new d(), new j(), !0, !0), s;
    }
    _LOOK(t, e, s, i, r, o, a, l) {
      const h = new S({
        state: t,
        alt: 0,
        context: s
      ...
      if (!r.has(h)) {
        if (r.add(h), t === e) {
          if (null === s) return void i.addOne(n.EPSILON);
          if (s.isEmpty() && l) return void i.addOne(n.EOF);
        }
        if (t instanceof A) {
          if (null === s) return void i.addOne(n.EPSILON);
          if (s.isEmpty() && l) return void i.addOne(n.EOF);
          if (s !== U.EMPTY) {
            const n = o.has(t.ruleIndex);
            try {
              o.remove(t.ruleIndex);
              for (let t = 0; t < s.length; t++) {
                const n = this.atn.states[s.getReturnState(t)];
                this._LOOK(n, e, s.getParent(t), i, r, o, a, l);
              }
            } finally {
              n && o.add(t.ruleIndex);
            }
        ...
        for (let h = 0; h < t.transitions.length; h++) {
          const c = t.transitions[h];
          if (c.constructor === N) {
            if (o.has(c.target.ruleIndex)) continue;
            const t = V.create(s, c.followState.stateNumber);
            try {
              o.add(c.target.ruleIndex), this._LOOK(c.target, e, t, i, r, o, a, l);
            } finally {
              o.remove(c.target.ruleIndex);
            }
          } else if (c instanceof L) a ? this._LOOK(c.target, e, s, i, r, o, a, l) : i.addOne(W.HIT_PRED);else if (c.isEpsilon) this._LOOK(c.target, e, s, i, r, o, a, l);else if (c.constructor === k) i.addRange(n.MIN_USER_TOKEN_TYPE, this.atn.maxTokenType);else {
            let t = c.label;
            null !== t && (c instanceof I && (t = t.complement(n.MIN_USER_TOKEN_TYPE, this.atn.maxTokenType)), i.addSet(t));
          }
        }
      }
    }
  }
  W.HIT_PRED = n.INVALID_TYPE;
  class $ {
    constructor(t, e) {
    ...
    nextTokensInContext(t, e) {
      return new W(this).LOOK(t, null, e);
    }
    ...
    getExpectedTokens(t, e) {
      ...
      if (!i.contains(n.EPSILON)) return i;
      const r = new E();
      for (r.addSet(i), r.removeOne(n.EPSILON); null !== e && e.invokingState >= 0 && i.contains(n.EPSILON);) {
        const t = this.states[e.invokingState].transitions[0];
        i = this.nextTokens(t.followState), r.addSet(i), r.removeOne(n.EPSILON), e = e.parentCtx;
      }
      return i.contains(n.EPSILON) && r.addOne(n.EOF), r;
    }
  }
  ...
  class et extends _ {
    constructor() {
      return super(), this.stateType = _.RULE_START, this.stopState = null, this.isPrecedenceRule = !1, this;
    }
  }
  class nt extends J {
    constructor() {
  ...
  class ht extends C {
    constructor(t, e) {
      super(t), this.label_ = e, this.label = this.makeLabel(), this.serializationType = C.ATOM;
    }
    makeLabel() {
      const t = new E();
  ...
  class ct extends C {
    constructor(t, e, n) {
      super(t), this.serializationType = C.RANGE, this.start = e, this.stop = n, this.label = this.makeLabel();
    }
    makeLabel() {
      const t = new E();
  ...
  class ut extends C {
    constructor(t, e, n, s) {
      super(t), this.serializationType = C.ACTION, this.ruleIndex = e, this.actionIndex = void 0 === n ? -1 : n, this.isCtxDependent = void 0 !== s && s, this.isEpsilon = !0;
    }
    matches(t, e, n) {
      return !1;
    }
  ...
  class dt extends C {
    constructor(t, e) {
      super(t), this.serializationType = C.EPSILON, this.isEpsilon = !0, this.outermostPrecedenceReturn = e;
    }
    matches(t, e, n) {
      return !1;
    }
  ...
  class pt extends p {
    ...
    equals(t) {
      return this === t || t instanceof pt && this.ruleIndex === t.ruleIndex && this.predIndex === t.predIndex && this.isCtxDependent === t.isCtxDependent;
    }
    toString() {
  ...
  class gt extends L {
    constructor(t, e, n, s) {
      super(t), this.serializationType = C.PREDICATE, this.ruleIndex = e, this.predIndex = n, this.isCtxDependent = s, this.isEpsilon = !0;
    }
    matches(t, e, n) {
      return !1;
    }
  ...
  class ft extends p {
    ...
    evalPrecedence(t, e) {
      return t.precpred(e, this.precedence) ? p.NONE : null;
    }
    compareTo(t) {
    ...
    equals(t) {
      return this === t || t instanceof ft && this.precedence === t.precedence;
    }
    toString() {
  ...
  class xt extends L {
    constructor(t, e) {
      super(t), this.serializationType = C.PRECEDENCE, this.precedence = e, this.isEpsilon = !0;
    }
    matches(t, e, n) {
      return !1;
    }
  ...
  class _t extends St {
    ...
    equals(t) {
      return this === t || t instanceof _t && this.ruleIndex === t.ruleIndex && this.actionIndex === t.actionIndex;
    }
  }
  class At extends St {
    constructor() {
  ...
  class Nt extends St {
    ...
    equals(t) {
      return this === t || t instanceof Nt && this.mode === t.mode;
    }
    toString() {
  ...
  class Lt {
    constructor(t) {
      null == t && (t = Tt.defaultOptions), this.deserializationOptions = t, this.stateFactories = null, this.actionFactories = null;
    }
    deserialize(t) {
    ...
    readStates(t, e) {
      ...
      let l = this.readInt();
      for (n = 0; n < l; n++) i = this.readInt(), t.states[i].nonGreedy = !0;
      let h = this.readInt();
    ...
    readRules(t, e) {
      ...
      for (0 === t.grammarType && (t.ruleToTokenType = kt(i, 0)), t.ruleToStartState = kt(i, 0), s = 0; s < i; s++) {
        const i = this.readInt();
        if (t.ruleToStartState[s] = t.states[i], 0 === t.grammarType) {
          let i = this.readInt();
          e && 65535 === i && (i = n.EOF), t.ruleToTokenType[s] = i;
        }
      }
      for (t.ruleToStopState = kt(i, 0), s = 0; s < t.states.length; s++) {
        const e = t.states[s];
        e instanceof A && (t.ruleToStopState[e.ruleIndex] = e, t.ruleToStartState[e.ruleIndex].stopState = e);
      }
    }
    readModes(t) {
      const e = this.readInt();
    ...
    readEdges(t, e) {
      ...
      for (n = 0; n < a; n++) {
        const n = this.readInt(),
          ...
          a = this.readInt(),
          l = this.readInt();
        r = this.edgeFactory(t, i, n, s, o, a, l, e), t.states[n].addTransition(r);
      }
      for (n = 0; n < t.states.length; n++) for (i = t.states[n], s = 0; s < i.transitions.length; s++) {
        ...
        let n = -1;
        t.ruleToStartState[e.target.ruleIndex].isPrecedenceRule && 0 === e.precedence && (n = e.target.ruleIndex), r = new dt(e.followState, n), t.ruleToStopState[e.target.ruleIndex].addTransition(r);
      }
      for (n = 0; n < t.states.length; n++) {
        if (i = t.states[n], i instanceof Q) {
          if (null === i.endState) throw "IllegalState";
          if (null !== i.endState.startState) throw "IllegalState";
          i.endState.startState = i;
        }
        if (i instanceof st) for (s = 0; s < i.transitions.length; s++) o = i.transitions[s].target, o instanceof ot && (o.loopBackState = i);else if (i instanceof it) for (s = 0; s < i.transitions.length; s++) o = i.transitions[s].target, o instanceof rt && (o.loopBackState = i);
      }
    }
    readDecisions(t) {
      const e = this.readInt();
    ...
    generateRuleBypassTransition(t, e) {
      ...
      if (t.ruleToStartState[e].isPrecedenceRule) {
        for (a = null, n = 0; n < t.states.length; n++) if (s = t.states[n], this.stateIsEndStateFor(s, e)) {
          a = s, o = s.loopBackState.transitions[0];
          break;
        }
      ...
      for (n = 0; n < t.states.length; n++) {
        ...
        for (let t = 0; t < s.transitions.length; t++) {
          ...
          e !== o && e.target === a && (e.target = r);
        }
      }
      const l = t.ruleToStartState[e],
        h = l.transitions.length;
      for (; h > 0;) i.addTransition(l.transitions[h - 1]), l.transitions = l.transitions.slice(-1);
      t.ruleToStartState[e].addTransition(new dt(i)), r.addTransition(new dt(a));
      const c = new X();
      t.addState(c), c.addTransition(new ht(r, t.ruleToTokenType[e])), i.addTransition(new dt(c));
    }
    stateIsEndStateFor(t, e) {
      ...
      return n instanceof tt && n.epsilonOnlyTransitions && n.transitions[0].target instanceof A ? t : null;
    }
    markPrecedenceDecisions(t) {
      for (let e = 0; e < t.states.length; e++) {
        const n = t.states[e];
        if (n instanceof rt && t.ruleToStartState[n.ruleIndex].isPrecedenceRule) {
          const t = n.transitions[n.transitions.length - 1].target;
          t instanceof tt && t.epsilonOnlyTransitions && t.transitions[0].target instanceof A && (n.isPrecedenceDecision = !0);
        }
      }
    }
    verifyATN(t) {
      if (this.deserializationOptions.verifyATN) for (let e = 0; e < t.states.length; e++) {
        const n = t.states[e];
        if (null !== n) if (this.checkCondition(n.epsilonOnlyTransitions || n.transitions.length <= 1), n instanceof ot) this.checkCondition(null !== n.loopBackState);else if (n instanceof rt) {
          if (this.checkCondition(null !== n.loopBackState), this.checkCondition(2 === n.transitions.length), n.transitions[0].target instanceof at) this.checkCondition(n.transitions[1].target instanceof tt), this.checkCondition(!n.nonGreedy);else {
            if (!(n.transitions[0].target instanceof tt)) throw "IllegalState";
            this.checkCondition(n.transitions[1].target instanceof at), this.checkCondition(n.nonGreedy);
          }
        } else n instanceof it ? (this.checkCondition(1 === n.transitions.length), this.checkCondition(n.transitions[0].target instanceof rt)) : n instanceof tt ? this.checkCondition(null !== n.loopBackState) : n instanceof et ? this.checkCondition(null !== n.stopState) : n instanceof Q ? this.checkCondition(null !== n.endState) : n instanceof Z ? this.checkCondition(null !== n.startState) : n instanceof J ? this.checkCondition(n.transitions.length <= 1 || n.decision >= 0) : this.checkCondition(n.transitions.length <= 1 || n instanceof A);
      }
    }
    checkCondition(t, e) {
    ...
    edgeFactory(t, e, s, i, r, o, a, l) {
      const h = t.states[i];
      switch (e) {
        case C.EPSILON:
          return new dt(h);
        case C.RANGE:
          return new ct(h, 0 !== a ? n.EOF : r, o);
        case C.RULE:
          return new N(t.states[r], o, a, h);
        case C.PREDICATE:
          return new gt(h, r, o, 0 !== a);
        case C.PRECEDENCE:
          return new xt(h, r);
        case C.ATOM:
          return new ht(h, 0 !== a ? n.EOF : r);
        case C.ACTION:
          return new ut(h, r, o, 0 !== a);
        case C.SET:
          return new y(h, l[r]);
        case C.NOT_SET:
          return new I(h, l[r]);
    ...
    stateFactory(t, e) {
      if (null === this.stateFactories) {
        const t = [];
        t[_.INVALID_TYPE] = null, t[_.BASIC] = () => new X(), t[_.RULE_START] = () => new et(), t[_.BLOCK_START] = () => new lt(), t[_.PLUS_BLOCK_START] = () => new ot(), t[_.STAR_BLOCK_START] = () => new at(), t[_.TOKEN_START] = () => new nt(), t[_.RULE_STOP] = () => new A(), t[_.BLOCK_END] = () => new Z(), t[_.STAR_LOOP_BACK] = () => new it(), t[_.STAR_LOOP_ENTRY] = () => new rt(), t[_.PLUS_LOOP_BACK] = () => new st(), t[_.LOOP_END] = () => new tt(), this.stateFactories = t;
      }
    ...
    lexerActionFactory(t, e, n) {
      if (null === this.actionFactories) {
        const t = [];
        t[0] = (t, e) => new Et(t), t[1] = (t, e) => new _t(t, e), t[2] = (t, e) => new It(t), t[3] = (t, e) => At.INSTANCE, t[4] = (t, e) => yt.INSTANCE, t[5] = (t, e) => new Nt(t), t[6] = (t, e) => mt.INSTANCE, t[7] = (t, e) => new Ct(t), this.actionFactories = t;
      }
  ...
  class Rt extends Ot {
    ...
    reportAmbiguity(t, e, n, s, i, r, o) {
      this.delegates.map(a => a.reportAmbiguity(t, e, n, s, i, r, o));
    }
    reportAttemptingFullContext(t, e, n, s, i, r) {
  ...
  class wt {
    ...
    getTokenTypeMap() {
      ...
      return void 0 === e && (e = t.reduce(function (t, e, n) {
        t[e] = n;
      }), e.EOF = n.EOF, this.tokenTypeMapCache[t] = e), e;
    }
    getRuleIndexMap() {
    ...
    getTokenType(t) {
      ...
      return void 0 !== e ? e : n.INVALID_TYPE;
    }
    getErrorHeader(t) {
    ...
    getTokenErrorDisplay(t) {
      ...
      let e = t.text;
      return null === e && (e = t.type === n.EOF ? "<EOF>" : "<" + t.type + ">"), e = e.replace("\n", "\\n").replace("\r", "\\r").replace("\t", "\\t"), "'" + e + "'";
    }
  ...
  class Pt extends n {
    constructor(t, e, s, i, r) {
      super(), this.source = void 0 !== t ? t : Pt.EMPTY_SOURCE, this.type = void 0 !== e ? e : null, this.channel = void 0 !== s ? s : n.DEFAULT_CHANNEL, this.start = void 0 !== i ? i : -1, this.stop = void 0 !== r ? r : -1, this.tokenIndex = -1, null !== this.source[0] ? (this.line = t[0].line, this.column = t[0].column) : this.column = -1;
    }
    clone() {
      const t = new Pt(this.source, this.type, this.channel, this.start, this.stop);
      return t.tokenIndex = this.tokenIndex, t.line = this.line, t.column = this.column, t.text = this.text, t;
    }
    cloneWithType(t) {
      const e = new Pt(this.source, t, this.channel, this.start, this.stop);
      return e.tokenIndex = this.tokenIndex, e.line = this.line, e.column = this.column, t === n.EOF && (e.text = ""), e;
    }
    toString() {
      let t = this.text;
  ...
  class Dt extends bt {
    ...
    create(t, e, n, s, i, r, o, a) {
      const l = new Pt(t, e, s, i, r);
      return l.line = o, l.column = a, null !== n ? l.text = n : this.copyText && null !== t[1] && (l.text = t[1].getText(i, r)), l;
    }
    createThin(t, e) {
      const n = new Pt(null, t);
      return n.text = e, n;
    }
  }
  Dt.DEFAULT = new Dt();
  class Ft extends Error {
    constructor(t) {
      super(t.message), Error.captureStackTrace && Error.captureStackTrace(this, Ft), this.message = t.message, this.recognizer = t.recognizer, this.input = t.input, this.ctx = t.ctx, this.offendingToken = null, this.offendingState = -1, null !== this.recognizer && (this.offendingState = this.recognizer.state);
    }
    getExpectedTokens() {
  ...
  class Mt extends Ft {
    ...
    toString() {
      let t = "";
      return this.startIndex >= 0 && this.startIndex < this.input.size && (t = this.input.getText(new m(this.startIndex, this.startIndex))), "LexerNoViableAltException" + t;
    }
  }
  class Ut extends wt {
    constructor(t) {
      super(), this._input = t, this._factory = Dt.DEFAULT, this._tokenFactorySourcePair = [this, t], this._interp = null, this._token = null, this._tokenStartCharIndex = -1, this._tokenStartLine = -1, this._tokenStartColumn = -1, this._hitEOF = !1, this._channel = n.DEFAULT_CHANNEL, this._type = n.INVALID_TYPE, this._modeStack = [], this._mode = Ut.DEFAULT_MODE, this._text = null;
    }
    reset() {
      null !== this._input && this._input.seek(0), this._token = null, this._type = n.INVALID_TYPE, this._channel = n.DEFAULT_CHANNEL, this._tokenStartCharIndex = -1, this._tokenStartColumn = -1, this._tokenStartLine = -1, this._text = null, this._hitEOF = !1, this._mode = Ut.DEFAULT_MODE, this._modeStack = [], this._interp.reset();
    }
    nextToken() {
        ...
        for (;;) {
          ...
          for (;;) {
            ...
            try {
              ...
              if (!(t instanceof Ft)) throw console.log(t.stack), t;
              this.notifyListeners(t), this.recover(t);
            }
            if (this._input.LA(1) === n.EOF && (this._hitEOF = !0), this._type === n.INVALID_TYPE && (this._type = e), this._type === Ut.SKIP) {
              t = !0;
              break;
            }
    ...
    emitEOF() {
      const t = this.column,
        e = this.line,
        s = this._factory.create(this._tokenFactorySourcePair, n.EOF, null, n.DEFAULT_CHANNEL, this._input.index, this._input.index - 1, e, t);
    ...
    getAllTokens() {
      ...
      for (; e.type !== n.EOF;) t.push(e), e = this.nextToken();
      return t;
    }
    notifyListeners(t) {
      const e = this._tokenStartCharIndex,
        ...
        i = "token recognition error at: '" + this.getErrorDisplay(s) + "'";
    ...
    getErrorDisplayForChar(t) {
      return t.charCodeAt(0) === n.EOF ? "<EOF>" : "\n" === t ? "\\n" : "\t" === t ? "\\t" : "\r" === t ? "\\r" : t;
    }
    getCharErrorDisplay(t) {
      return "'" + this.getErrorDisplayForChar(t) + "'";
    }
    recover(t) {
      this._input.LA(1) !== n.EOF && (t instanceof Mt ? this._interp.consume(this._input) : this._input.consume());
    }
    get inputStream() {
      return this._input;
    }
  ...
  Ut.DEFAULT_MODE = 0, Ut.MORE = -2, Ut.SKIP = -3, Ut.DEFAULT_TOKEN_CHANNEL = n.DEFAULT_CHANNEL, Ut.HIDDEN = n.HIDDEN_CHANNEL, Ut.MIN_CHAR_VALUE = 0, Ut.MAX_CHAR_VALUE = 1114111;
  class zt {
    constructor(t) {
      this.configLookup = new d(Bt, Vt), this.fullCtx = void 0 === t || t, this.readOnly = !1, this.configs = [], this.uniqueAlt = 0, this.conflictingAlts = null, this.hasSemanticContext = !1, this.dipsIntoOuterContext = !1, this.cachedHashCode = -1;
    }
    add(t, e) {
      if (void 0 === e && (e = null), this.readOnly) throw "This set is readonly";
      t.semanticContext !== p.NONE && (this.hasSemanticContext = !0), t.reachesIntoOuterContext > 0 && (this.dipsIntoOuterContext = !0);
      const n = this.configLookup.add(t);
      if (n === t) return this.cachedHashCode = -1, this.configs.push(t), !0;
      const s = !this.fullCtx,
        i = G(n.context, t.context, s, e);
    ...
    getPredicates() {
      ...
      for (let e = 0; e < this.configs.length; e++) {
        ...
        n !== p.NONE && t.push(n.semanticContext);
      }
      return t;
    }
    optimizeConfigs(t) {
    ...
    equals(t) {
      return this === t || t instanceof zt && s(this.configs, t.configs) && this.fullCtx === t.fullCtx && this.uniqueAlt === t.uniqueAlt && this.conflictingAlts === t.conflictingAlts && this.hasSemanticContext === t.hasSemanticContext && this.dipsIntoOuterContext === t.dipsIntoOuterContext;
    }
    hashCode() {
      const t = new o();
    ...
    toString() {
      return c(this.configs) + (this.hasSemanticContext ? ",hasSemanticContext=" + this.hasSemanticContext : "") + (this.uniqueAlt !== $.INVALID_ALT_NUMBER ? ",uniqueAlt=" + this.uniqueAlt : "") + (null !== this.conflictingAlts ? ",conflictingAlts=" + this.conflictingAlts : "") + (this.dipsIntoOuterContext ? ",dipsIntoOuterContext" : "");
    }
    get items() {
      return this.configs;
    }
  ...
  class qt {
    constructor(t, e) {
      return null === t && (t = -1), null === e && (e = new zt()), this.stateNumber = t, this.configs = e, this.edges = null, this.isAcceptState = !1, this.prediction = 0, this.lexerActionExecutor = null, this.requiresFullContext = !1, this.predicates = null, this;
    }
    getAltSet() {
      const t = new d();
    ...
    equals(t) {
      return this === t || t instanceof qt && this.configs.equals(t.configs);
    }
    toString() {
  ...
  class Ht {
    ...
    getCachedContext(t) {
      ...
      const e = new H();
      return Y(t, this.sharedContextCache, e);
    }
  }
  ...
  class Yt extends S {
    constructor(t, e) {
      ...
      return this.lexerActionExecutor = n || (null !== e ? e.lexerActionExecutor : null), this.passedThroughNonGreedyDecision = null !== e && this.checkNonGreedyDecision(e, this.state), this.hashCodeForConfigSet = Yt.prototype.hashCode, this.equalsForConfigSet = Yt.prototype.equals, this;
    }
    updateHashCode(t) {
    ...
    equals(t) {
      return this === t || t instanceof Yt && this.passedThroughNonGreedyDecision === t.passedThroughNonGreedyDecision && (this.lexerActionExecutor ? this.lexerActionExecutor.equals(t.lexerActionExecutor) : !t.lexerActionExecutor) && super.equals(t);
    }
    checkNonGreedyDecision(t, e) {
      return t.passedThroughNonGreedyDecision || e instanceof J && e.nonGreedy;
    }
  }
  class Gt extends St {
    constructor(t, e) {
    ...
    equals(t) {
      return this === t || t instanceof Gt && this.offset === t.offset && this.action === t.action;
    }
  }
  class jt {
    constructor(t) {
      return this.lexerActions = null === t ? [] : t, this.cachedHashCode = o.hashStuff(t), this;
    }
    fixOffsetBeforeMatch(t) {
      let e = null;
      for (let n = 0; n < this.lexerActions.length; n++) !this.lexerActions[n].isPositionDependent || this.lexerActions[n] instanceof Gt || (null === e && (e = this.lexerActions.concat([])), e[n] = new Gt(t, this.lexerActions[n]));
      return null === e ? this : new jt(e);
    }
    execute(t, e, n) {
      let s = !1;
      const i = e.index;
  ...
  class Xt extends Ht {
    constructor(t, e, n, s) {
      super(e, s), this.decisionToDFA = n, this.recog = t, this.startIndex = -1, this.line = 1, this.column = 0, this.mode = Ut.DEFAULT_MODE, this.prevAccept = new $t();
    }
    copyState(t) {
    ...
    match(t, e) {
      ...
      try {
        ...
        const n = this.decisionToDFA[e];
        return null === n.s0 ? this.matchATN(t) : this.execATN(t, n.s0);
      } finally {
        t.release(n);
      }
    }
    ...
    matchATN(t) {
      ...
      Xt.debug && console.log("matchATN mode " + this.mode + " start: " + e);
      const n = this.mode,
        s = this.computeStartState(t, e),
        i = s.hasSemanticContext;
      s.hasSemanticContext = !1;
      const r = this.addDFAState(s);
      i || (this.decisionToDFA[this.mode].s0 = r);
      const o = this.execATN(t, r);
      return Xt.debug && console.log("DFA after matchATN: " + this.decisionToDFA[n].toLexerString()), o;
    }
    execATN(t, e) {
      Xt.debug && console.log("start state closure=" + e.configs), e.isAcceptState && this.captureSimState(this.prevAccept, t, e);
      let s = t.LA(1),
        i = e;
      for (;;) {
        Xt.debug && console.log("execATN loop starting closure: " + i.configs);
        let e = this.getExistingTargetState(i, s);
        if (null === e && (e = this.computeTargetState(t, i, s)), e === Ht.ERROR) break;
        if (s !== n.EOF && this.consume(t), e.isAcceptState && (this.captureSimState(this.prevAccept, t, e), s === n.EOF)) break;
        s = t.LA(1), i = e;
      }
      return this.failOrAccept(this.prevAccept, t, i.configs, s);
    }
    getExistingTargetState(t, e) {
      if (null === t.edges || e < Xt.MIN_DFA_EDGE || e > Xt.MAX_DFA_EDGE) return null;
      let n = t.edges[e - Xt.MIN_DFA_EDGE];
      return void 0 === n && (n = null), Xt.debug && null !== n && console.log("reuse state " + t.stateNumber + " edge to " + n.stateNumber), n;
    }
    computeTargetState(t, e, n) {
      const s = new Kt();
      return this.getReachableConfigSet(t, e.configs, s, n), 0 === s.items.length ? (s.hasSemanticContext || this.addDFAEdge(e, n, Ht.ERROR), Ht.ERROR) : this.addDFAEdge(e, n, null, s);
    }
    failOrAccept(t, e, s, i) {
      ...
      if (i === n.EOF && e.index === this.startIndex) return n.EOF;
      throw new Mt(this.recog, e, this.startIndex, s);
    }
    getReachableConfigSet(t, e, s, i) {
      let r = $.INVALID_ALT_NUMBER;
      for (let o = 0; o < e.items.length; o++) {
        const a = e.items[o],
          l = a.alt === r;
        if (!l || !a.passedThroughNonGreedyDecision) {
          Xt.debug && console.log("testing %s at %s\n", this.getTokenName(i), a.toString(this.recog, !0));
          for (let e = 0; e < a.state.transitions.length; e++) {
            const o = a.state.transitions[e],
              h = this.getReachableTarget(o, i);
            if (null !== h) {
              ...
              this.closure(t, c, s, l, !0, o) && (r = a.alt);
            }
          }
        }
      }
    ...
    getReachableTarget(t, e) {
      return t.matches(e, 0, Ut.MAX_CHAR_VALUE) ? t.target : null;
    }
    computeStartState(t, e) {
      const n = U.EMPTY,
        s = new Kt();
      for (let i = 0; i < e.transitions.length; i++) {
        const r = e.transitions[i].target,
          o = new Yt({
            state: r,
            alt: i + 1,
            context: n
    ...
    closure(t, e, n, s, i, r) {
      let o = null;
      if (Xt.debug && console.log("closure(" + e.toString(this.recog, !0) + ")"), e.state instanceof A) {
        ...
        if (null !== e.context && !e.context.isEmpty()) for (let a = 0; a < e.context.length; a++) if (e.context.getReturnState(a) !== U.EMPTY_RETURN_STATE) {
          const l = e.context.getParent(a),
            h = this.atn.states[e.context.getReturnState(a)];
          o = new Yt({
            state: h,
            context: l
      ...
      for (let a = 0; a < e.state.transitions.length; a++) {
        ...
        o = this.getEpsilonTarget(t, e, l, n, i, r), null !== o && (s = this.closure(t, o, n, s, i, r));
      }
      return s;
    }
    getEpsilonTarget(t, e, s, i, r, o) {
      let a = null;
      if (s.serializationType === C.RULE) {
        const t = V.create(e.context, s.followState.stateNumber);
        a = new Yt({
          state: s.target,
          context: t
        }, e);
      } else {
        if (s.serializationType === C.PRECEDENCE) throw "Precedence predicates are not supported in lexers.";
        if (s.serializationType === C.PREDICATE) Xt.debug && console.log("EVAL rule " + s.ruleIndex + ":" + s.predIndex), i.hasSemanticContext = !0, this.evaluatePredicate(t, s.ruleIndex, s.predIndex, r) && (a = new Yt({
          state: s.target
        }, e));else if (s.serializationType === C.ACTION) {
          if (null === e.context || e.context.hasEmptyPath()) {
            const t = jt.append(e.lexerActionExecutor, this.atn.lexerActions[s.actionIndex]);
            a = new Yt({
              state: s.target,
        ...
        } else s.serializationType === C.EPSILON ? a = new Yt({
          state: s.target
        }, e) : s.serializationType !== C.ATOM && s.serializationType !== C.RANGE && s.serializationType !== C.SET || o && s.matches(n.EOF, 0, Ut.MAX_CHAR_VALUE) && (a = new Yt({
          state: s.target
        }, e));
      }
      return a;
    ...
    evaluatePredicate(t, e, n, s) {
      ...
      try {
        ...
        this.column = i, this.line = r, t.seek(o), t.release(a);
      }
    }
    ...
    addDFAEdge(t, e, n, s) {
      ...
      return e < Xt.MIN_DFA_EDGE || e > Xt.MAX_DFA_EDGE || (Xt.debug && console.log("EDGE " + t + " -> " + n + " upon " + e), null === t.edges && (t.edges = []), t.edges[e - Xt.MIN_DFA_EDGE] = n), n;
    }
    addDFAState(t) {
      const e = new qt(null, t);
      let n = null;
      for (let e = 0; e < t.items.length; e++) {
        const s = t.items[e];
        if (s.state instanceof A) {
          n = s;
          break;
        }
      }
  ...
  const Zt = {
      ...
      hasSLLConflictTerminatingPrediction: function (t, e) {
        if (Zt.allConfigsInRuleStopStates(e)) return !0;
        if (t === Zt.SLL && e.hasSemanticContext) {
          const t = new zt();
          for (let n = 0; n < e.items.length; n++) {
            let s = e.items[n];
            s = new S({
              semanticContext: p.NONE
            }, s), t.add(s);
          }
          e = t;
        }
        const n = Zt.getConflictingAltSubsets(e);
        return Zt.hasConflictingAltSet(n) && !Zt.hasStateAssociatedWithOneAlt(e);
      },
      hasConfigInRuleStopState: function (t) {
        for (let e = 0; e < t.items.length; e++) if (t.items[e].state instanceof A) return !0;
        return !1;
      },
      allConfigsInRuleStopStates: function (t) {
        for (let e = 0; e < t.items.length; e++) if (!(t.items[e].state instanceof A)) return !1;
        return !0;
      },
      resolvesToJustOneViableAlt: function (t) {
        return Zt.getSingleViableAlt(t);
      },
      allSubsetsConflict: function (t) {
        return !Zt.hasNonConflictingAltSet(t);
      },
      ...
      allSubsetsEqual: function (t) {
        ...
        for (let n = 0; n < t.length; n++) {
          const s = t[n];
          if (null === e) e = s;else if (s !== e) return !1;
        }
        return !0;
      },
      getUniqueAlt: function (t) {
        const e = Zt.getAlts(t);
        return 1 === e.length ? e.minValue() : $.INVALID_ALT_NUMBER;
      },
      getAlts: function (t) {
        const e = new j();
      ...
      getConflictingAltSubsets: function (t) {
        ...
        return e.hashFunction = function (t) {
          o.hashStuff(t.state.stateNumber, t.context);
          ...
          let n = e.get(t);
          null === n && (n = new j(), e.set(t, n)), n.add(t.alt);
        }), e.getValues();
      },
      getStateToAltMap: function (t) {
        ...
        return t.items.map(function (t) {
          let n = e.get(t.state);
          null === n && (n = new j(), e.set(t.state, n)), n.add(t.alt);
        }), e;
      },
      hasStateAssociatedWithOneAlt: function (t) {
        const e = Zt.getStateToAltMap(t).values();
      ...
      getSingleViableAlt: function (t) {
        ...
        for (let n = 0; n < t.length; n++) {
          ...
          if (null === e) e = s;else if (e !== s) return $.INVALID_ALT_NUMBER;
        }
        return e;
      }
    },
  ...
  class ne {
    constructor(t) {
      this.defaultMapCtor = t || H, this.cacheMap = new this.defaultMapCtor();
    }
    get(t, e) {
  ...
  class se extends Ht {
    constructor(t, e, n, s) {
      super(e, s), this.parser = t, this.decisionToDFA = n, this.predictionMode = te.LL, this._input = null, this._startIndex = 0, this._outerContext = null, this._dfa = null, this.mergeCache = null, this.debug = !1, this.debug_closure = !1, this.debug_add = !1, this.trace_atn_sim = !1, this.dfa_debug = !1, this.retry_debug = !1;
    }
    reset() {}
    adaptivePredict(t, e, n) {
      ...
      try {
        ...
        if (e = s.precedenceDfa ? s.getPrecedenceStartState(this.parser.getPrecedence()) : s.s0, null === e) {
          null === n && (n = M.EMPTY), this.debug && console.log("predictATN decision " + s.decision + " exec LA(1)==" + this.getLookaheadName(t) + ", outerContext=" + n.toString(this.parser.ruleNames));
          const i = !1;
          let r = this.computeStartState(s.atnStartState, M.EMPTY, i);
          s.precedenceDfa ? (s.s0.configs = r, r = this.applyPrecedenceFilter(r), e = this.addDFAState(s, new qt(null, r)), s.setPrecedenceStartState(this.parser.getPrecedence(), e)) : (e = this.addDFAState(s, new qt(null, r)), s.s0 = e);
        }
        const i = this.execATN(s, e, t, r, n);
        return this.debug && console.log("DFA after predictATN: " + s.toString(this.parser.literalNames, this.parser.symbolicNames)), i;
      } finally {
    ...
    execATN(t, e, s, i, r) {
      let o;
      (this.debug || this.trace_atn_sim) && console.log("execATN decision " + t.decision + ", DFA state " + e + ", LA(1)==" + this.getLookaheadName(s) + " line " + s.LT(1).line + ":" + s.LT(1).column);
      let a = e;
      this.debug && console.log("s0 = " + e);
      let l = s.LA(1);
      for (;;) {
        let e = this.getExistingTargetState(a, l);
        if (null === e && (e = this.computeTargetState(t, a, l)), e === Ht.ERROR) {
          const t = this.noViableAlt(s, r, a.configs, i);
          if (s.seek(i), o = this.getSynValidOrSemInvalidAltThatFinishedDecisionEntryRule(a.configs, r), o !== $.INVALID_ALT_NUMBER) return o;
          throw t;
        }
        if (e.requiresFullContext && this.predictionMode !== te.SLL) {
          let n = null;
          if (null !== e.predicates) {
            this.debug && console.log("DFA state has preds in DFA sim LL failover");
            const t = s.index;
            if (t !== i && s.seek(i), n = this.evalSemanticContext(e.predicates, r, !0), 1 === n.length) return this.debug && console.log("Full LL avoided"), n.minValue();
            t !== i && s.seek(t);
          }
          this.dfa_debug && console.log("ctx sensitive state " + r + " in " + e);
          const a = !0,
            l = this.computeStartState(t.atnStartState, r, a);
          return this.reportAttemptingFullContext(t, n, e.configs, i, s.index), o = this.execATNWithFullContext(t, e, l, s, i, r), o;
        }
        if (e.isAcceptState) {
          ...
          if (0 === o.length) throw this.noViableAlt(s, r, e.configs, i);
          return 1 === o.length || this.reportAmbiguity(t, e, i, n, !1, o, e.configs), o.minValue();
        }
        a = e, l !== n.EOF && (s.consume(), l = s.LA(1));
      }
    }
    getExistingTargetState(t, e) {
      const n = t.edges;
    ...
    computeTargetState(t, e, n) {
      ...
      if (null === s) return this.addDFAEdge(t, e, n, Ht.ERROR), Ht.ERROR;
      let i = new qt(null, s);
      const r = this.getUniqueAlt(s);
      if (this.debug) {
        const t = te.getConflictingAltSubsets(s);
        console.log("SLL altSubSets=" + c(t) + ", configs=" + s + ", predict=" + r + ", allSubsetsConflict=" + te.allSubsetsConflict(t) + ", conflictingAlts=" + this.getConflictingAlts(s));
      }
      return r !== $.INVALID_ALT_NUMBER ? (i.isAcceptState = !0, i.configs.uniqueAlt = r, i.prediction = r) : te.hasSLLConflictTerminatingPrediction(this.predictionMode, s) && (i.configs.conflictingAlts = this.getConflictingAlts(s), i.requiresFullContext = !0, i.isAcceptState = !0, i.prediction = i.configs.conflictingAlts.minValue()), i.isAcceptState && i.configs.hasSemanticContext && (this.predicateDFAState(i, this.atn.getDecisionState(t.decision)), null !== i.predicates && (i.prediction = $.INVALID_ALT_NUMBER)), i = this.addDFAEdge(t, e, n, i), i;
    }
    predicateDFAState(t, e) {
      const n = e.transitions.length,
        s = this.getConflictingAltsOrUniqueAlt(t.configs),
        i = this.getPredsForAmbigAlts(s, t.configs, n);
      null !== i ? (t.predicates = this.getPredicatePredictions(s, i), t.prediction = $.INVALID_ALT_NUMBER) : t.prediction = s.minValue();
    }
    execATNWithFullContext(t, e, s, i, r, o) {
      ...
      let c = i.LA(1),
        u = -1;
      for (;;) {
        if (a = this.computeReachSet(h, c, !0), null === a) {
          const t = this.noViableAlt(i, o, h, r);
          i.seek(r);
          const e = this.getSynValidOrSemInvalidAltThatFinishedDecisionEntryRule(h, o);
          if (e !== $.INVALID_ALT_NUMBER) return e;
          throw t;
        }
        const t = te.getConflictingAltSubsets(a);
        if (this.debug && console.log("LL altSubSets=" + t + ", predict=" + te.getUniqueAlt(t) + ", resolvesToJustOneViableAlt=" + te.resolvesToJustOneViableAlt(t)), a.uniqueAlt = this.getUniqueAlt(a), a.uniqueAlt !== $.INVALID_ALT_NUMBER) {
          u = a.uniqueAlt;
          break;
        }
        if (this.predictionMode !== te.LL_EXACT_AMBIG_DETECTION) {
          if (u = te.resolvesToJustOneViableAlt(t), u !== $.INVALID_ALT_NUMBER) break;
        } else if (te.allSubsetsConflict(t) && te.allSubsetsEqual(t)) {
          l = !0, u = te.getSingleViableAlt(t);
          break;
        }
        h = a, c !== n.EOF && (i.consume(), c = i.LA(1));
      }
      return a.uniqueAlt !== $.INVALID_ALT_NUMBER ? (this.reportContextSensitivity(t, u, a, r, i.index), u) : (this.reportAmbiguity(t, e, r, i.index, l, null, a), u);
    }
    computeReachSet(t, e, s) {
      this.debug && console.log("in computeReachSet, starting closure: " + t), null === this.mergeCache && (this.mergeCache = new ne());
      const i = new zt(s);
      let r = null;
      for (let o = 0; o < t.items.length; o++) {
        const a = t.items[o];
        if (this.debug && console.log("testing " + this.getTokenName(e) + " at " + a), a.state instanceof A) (s || e === n.EOF) && (null === r && (r = []), r.push(a), this.debug_add && console.log("added " + a + " to skippedStopStates"));else for (let t = 0; t < a.state.transitions.length; t++) {
          const n = a.state.transitions[t],
            s = this.getReachableTarget(n, e);
          if (null !== s) {
            const t = new S({
              state: s
            }, a);
      ...
      let o = null;
      if (null === r && e !== n.EOF && (1 === i.items.length || this.getUniqueAlt(i) !== $.INVALID_ALT_NUMBER) && (o = i), null === o) {
        o = new zt(s);
        const t = new d(),
          r = e === n.EOF;
        for (let e = 0; e < i.items.length; e++) this.closure(i.items[e], o, t, !1, s, r);
      }
      if (e === n.EOF && (o = this.removeAllConfigsNotInRuleStopState(o, o === i)), !(null === r || s && te.hasConfigInRuleStopState(o))) for (let t = 0; t < r.length; t++) o.add(r[t], this.mergeCache);
      return this.trace_atn_sim && console.log("computeReachSet " + t + " -> " + o), 0 === o.items.length ? null : o;
    }
    removeAllConfigsNotInRuleStopState(t, e) {
      if (te.allConfigsInRuleStopStates(t)) return t;
      const s = new zt(t.fullCtx);
      for (let i = 0; i < t.items.length; i++) {
        const r = t.items[i];
        if (r.state instanceof A) s.add(r, this.mergeCache);else if (e && r.state.epsilonOnlyTransitions && this.atn.nextTokens(r.state).contains(n.EPSILON)) {
    ...
    computeStartState(t, e, n) {
      ...
      for (let e = 0; e < t.transitions.length; e++) {
        const r = t.transitions[e].target,
          o = new S({
            state: r,
            alt: e + 1,
            context: s
    ...
    applyPrecedenceFilter(t) {
      ...
      for (let i = 0; i < t.items.length; i++) {
        ...
        null !== r && (n[e.state.stateNumber] = e.context, r !== e.semanticContext ? s.add(new S({
          semanticContext: r
    ...
    getPredsForAmbigAlts(t, e, n) {
      ...
      for (let n = 0; n < e.items.length; n++) {
        const i = e.items[n];
        t.has(i.alt) && (s[i.alt] = p.orContext(s[i.alt] || null, i.semanticContext));
      }
      let i = 0;
      for (let t = 1; t < n + 1; t++) {
        const e = s[t] || null;
        null === e ? s[t] = p.NONE : e !== p.NONE && (i += 1);
      }
      return 0 === i && (s = null), this.debug && console.log("getPredsForAmbigAlts result " + c(s)), s;
    }
    getPredicatePredictions(t, e) {
      ...
      for (let i = 1; i < e.length; i++) {
        const r = e[i];
        null !== t && t.has(i) && n.push(new Jt(r, i)), r !== p.NONE && (s = !0);
      }
      return s ? n : null;
    }
    getSynValidOrSemInvalidAltThatFinishedDecisionEntryRule(t, e) {
      ...
      return r !== $.INVALID_ALT_NUMBER || i.items.length > 0 && (r = this.getAltThatFinishedDecisionEntryRule(i), r !== $.INVALID_ALT_NUMBER) ? r : $.INVALID_ALT_NUMBER;
    }
    getAltThatFinishedDecisionEntryRule(t) {
      const e = [];
      for (let n = 0; n < t.items.length; n++) {
        const s = t.items[n];
        (s.reachesIntoOuterContext > 0 || s.state instanceof A && s.context.hasEmptyPath()) && e.indexOf(s.alt) < 0 && e.push(s.alt);
      }
      return 0 === e.length ? $.INVALID_ALT_NUMBER : Math.min.apply(null, e);
    }
    splitAccordingToSemanticValidity(t, e) {
      const n = new zt(t.fullCtx),
        s = new zt(t.fullCtx);
      for (let i = 0; i < t.items.length; i++) {
        const r = t.items[i];
        r.semanticContext !== p.NONE ? r.semanticContext.evaluate(this.parser, e) ? n.add(r) : s.add(r) : n.add(r);
      }
      return [n, s];
    }
    ...
    closureCheckingStopState(t, e, n, s, i, r, o) {
      if ((this.trace_atn_sim || this.debug_closure) && console.log("closure(" + t.toString(this.parser, !0) + ")"), t.state instanceof A) {
        if (!t.context.isEmpty()) {
          for (let a = 0; a < t.context.length; a++) {
            if (t.context.getReturnState(a) === U.EMPTY_RETURN_STATE) {
              if (i) {
                e.add(new S({
                  state: t.state,
                  context: U.EMPTY
    ...
    closure_(t, e, n, s, i, r, o) {
      ...
      for (let l = 0; l < a.transitions.length; l++) {
        ...
        const h = a.transitions[l],
          c = s && !(h instanceof ut),
          u = this.getEpsilonTarget(t, h, c, 0 === r, i, o);
        if (null !== u) {
          let s = r;
          if (t.state instanceof A) {
    ...
    canDropLoopEntryEdgeInLeftRecursiveRule(t) {
      const e = t.state;
      if (e.stateType !== _.STAR_LOOP_ENTRY) return !1;
      if (e.stateType !== _.STAR_LOOP_ENTRY || !e.isPrecedenceDecision || t.context.isEmpty() || t.context.hasEmptyPath()) return !1;
      ...
      for (let s = 0; s < n; s++) {
        ...
        if (!(r.stateType === _.BLOCK_END && o === e || r === i || o === i || o.stateType === _.BLOCK_END && 1 === o.transitions.length && o.transitions[0].isEpsilon && o.transitions[0].target === e)) return !1;
      }
      return !0;
    }
    getRuleName(t) {
    ...
    getEpsilonTarget(t, e, s, i, r, o) {
      switch (e.serializationType) {
        ...
        case C.PRECEDENCE:
          return this.precedenceTransition(t, e, s, i, r);
        case C.PREDICATE:
          return this.predTransition(t, e, s, i, r);
        case C.ACTION:
        ...
        case C.RANGE:
        case C.SET:
          return o && e.matches(n.EOF, 0, 1) ? new S({
            state: e.target
          }, t) : null;
        default:
          return null;
    ...
    precedenceTransition(t, e, n, s, i) {
      this.debug && (console.log("PRED (collectPredicates=" + n + ") " + e.precedence + ">=_p, ctx dependent=true"), null !== this.parser && console.log("context surrounding pred is " + c(this.parser.getRuleInvocationStack())));
      let r = null;
      if (n && s) {
        if (i) {
          ...
          this._input.seek(n), s && (r = new S({
            state: e.target
          }, t));
        } else {
          const n = p.andContext(t.semanticContext, e.getPredicate());
          r = new S({
            state: e.target,
            semanticContext: n
          }, t);
    ...
    predTransition(t, e, n, s, i) {
      this.debug && (console.log("PRED (collectPredicates=" + n + ") " + e.ruleIndex + ":" + e.predIndex + ", ctx dependent=" + e.isCtxDependent), null !== this.parser && console.log("context surrounding pred is " + c(this.parser.getRuleInvocationStack())));
      let r = null;
      if (n && (e.isCtxDependent && s || !e.isCtxDependent)) {
        if (i) {
          const n = this._input.index;
          this._input.seek(this._startIndex);
          const s = e.getPredicate().evaluate(this.parser, this._outerContext);
    ...
    ruleTransition(t, e) {
      ...
      const n = e.followState,
        s = V.create(t.context, n.stateNumber);
      return new S({
        state: e.target,
        context: s
      }, t);
    ...
    getConflictingAlts(t) {
      const e = te.getConflictingAltSubsets(t);
      return te.getAlts(e);
    }
    getConflictingAltsOrUniqueAlt(t) {
      let e = null;
      return t.uniqueAlt !== $.INVALID_ALT_NUMBER ? (e = new j(), e.add(t.uniqueAlt)) : e = t.conflictingAlts, e;
    }
    getTokenName(t) {
      if (t === n.EOF) return "EOF";
    ...
    dumpDeadEndConfigs(t) {
      ...
      for (let t = 0; t < e.length; t++) {
        ...
        if (n.state.transitions.length > 0) {
          ...
          t instanceof ht ? s = "Atom " + this.getTokenName(t.label) : t instanceof y && (s = (t instanceof I ? "~" : "") + "Set " + t.set);
        }
        console.error(n.toString(this.parser, !0) + ":" + s);
      }
    }
    noViableAlt(t, e, n, s) {
      return new ee(this.parser, t, t.get(s), t.LT(1), n, e);
    }
    getUniqueAlt(t) {
      let e = $.INVALID_ALT_NUMBER;
      for (let n = 0; n < t.items.length; n++) {
        const s = t.items[n];
        if (e === $.INVALID_ALT_NUMBER) e = s.alt;else if (s.alt !== e) return $.INVALID_ALT_NUMBER;
      }
      return e;
    }
    addDFAEdge(t, e, n, s) {
    ...
    addDFAState(t, e) {
      if (e === Ht.ERROR) return e;
      const n = t.states.get(e);
      return null !== n ? (this.trace_atn_sim && console.log("addDFAState " + e + " exists"), n) : (e.stateNumber = t.states.length, e.configs.readOnly || (e.configs.optimizeConfigs(this), e.configs.setReadonly(!0)), this.trace_atn_sim && console.log("addDFAState new " + e), t.states.add(e), this.debug && console.log("adding new DFA state: " + e), e);
    }
  ...
  class oe {
    ...
    getStateString(t) {
      ...
      return t.isAcceptState ? null !== t.predicates ? e + "=>" + c(t.predicates) : e + "=>" + t.prediction.toString() : e;
    }
  }
  class ae extends oe {
    constructor(t) {
  ...
  class le {
    constructor(t, e) {
      if (void 0 === e && (e = 0), this.atnStartState = t, this.decision = e, this._states = new d(), this.s0 = null, this.precedenceDfa = !1, t instanceof rt && t.isPrecedenceDecision) {
        this.precedenceDfa = !0;
        const t = new qt(null, new zt());
    ...
    toString(t, e) {
      return t = t || null, e = e || null, null === this.s0 ? "" : new oe(this, t, e).toString();
    }
    toLexerString() {
  ...
  class ge {
    walk(t, e) {
      if (e instanceof b || void 0 !== e.isErrorNode && e.isErrorNode()) t.visitErrorNode(e);else if (e instanceof P) t.visitTerminal(e);else {
        this.enterRule(t, e);
  ...
  class Te extends Ft {
    constructor(t, e, n) {
      ...
      s instanceof gt ? (this.ruleIndex = s.ruleIndex, this.predicateIndex = s.predIndex) : (this.ruleIndex = 0, this.predicateIndex = 0), this.predicate = e, this.offendingToken = t.getCurrentToken();
    }
  }
  function Se(t, e) {
  ...
  class me extends Ot {
    ...
    reportAmbiguity(t, e, n, s, i, r, o) {
      ...
      const a = "reportAmbiguity d=" + this.getDecisionDescription(t, e) + ": ambigAlts=" + this.getConflictingAlts(r, o) + ", input='" + t.getTokenStream().getText(new m(n, s)) + "'";
      t.notifyErrorListeners(a);
    }
    reportAttemptingFullContext(t, e, n, s, i, r) {
      const o = "reportAttemptingFullContext d=" + this.getDecisionDescription(t, e) + ", input='" + t.getTokenStream().getText(new m(n, s)) + "'";
      t.notifyErrorListeners(o);
    }
    reportContextSensitivity(t, e, n, s, i, r) {
      const o = "reportContextSensitivity d=" + this.getDecisionDescription(t, e) + ", input='" + t.getTokenStream().getText(new m(n, s)) + "'";
      t.notifyErrorListeners(o);
    }
  ...
  class Ae extends _e {
    ...
    reportError(t, e) {
      this.inErrorRecoveryMode(t) || (this.beginErrorCondition(t), e instanceof ee ? this.reportNoViableAlternative(t, e) : e instanceof xe ? this.reportInputMismatch(t, e) : e instanceof Te ? this.reportFailedPredicate(t, e) : (console.log("unknown recognition error type: " + e.constructor.name), console.log(e.stack), t.notifyErrorListeners(e.getOffendingToken(), e.getMessage(), e)));
    }
    recover(t, e) {
    ...
    sync(t) {
      ...
      const e = t._interp.atn.states[t.state],
        s = t.getTokenStream().LA(1),
        i = t.atn.nextTokens(e);
      if (i.contains(s)) return this.nextTokensContext = null, void (this.nextTokenState = _.INVALID_STATE_NUMBER);
      if (i.contains(n.EPSILON)) null === this.nextTokensContext && (this.nextTokensContext = t._ctx, this.nextTokensState = t._stateNumber);else switch (e.stateType) {
        case _.BLOCK_START:
    ...
    reportNoViableAlternative(t, e) {
      const s = t.getTokenStream();
      let i;
      i = null !== s ? e.startToken.type === n.EOF ? "<EOF>" : s.getText(new m(e.startToken.tokenIndex, e.offendingToken.tokenIndex)) : "<unknown input>";
    ...
    getMissingSymbol(t) {
      const e = t.getCurrentToken(),
        s = this.getExpectedTokens(t).first();
      let i;
      i = s === n.EOF ? "<missing EOF>" : "<missing " + t.literalNames[s] + ">";
      let r = e;
      const o = t.getTokenStream().LT(-1);
      return r.type === n.EOF && null !== o && (r = o), t.getTokenFactory().create(r.source, s, i, n.DEFAULT_CHANNEL, -1, -1, r.line, r.column);
    }
    getExpectedTokens(t) {
    ...
    getTokenErrorDisplay(t) {
      if (null === t) return "<no token>";
      let e = t.text;
      return null === e && (e = t.type === n.EOF ? "<EOF>" : "<" + t.type + ">"), this.escapeWSAndQuote(e);
    }
    escapeWSAndQuote(t) {
    ...
    getErrorRecoverySet(t) {
      ...
      for (; null !== s && s.invokingState >= 0;) {
        const t = e.states[s.invokingState].transitions[0],
          n = e.nextTokens(t.followState);
        i.addSet(n), s = s.parentCtx;
      }
      return i.removeOne(n.EPSILON), i;
    }
    consumeUntil(t, e) {
      let s = t.getTokenStream().LA(1);
      for (; s !== n.EOF && !e.contains(s);) t.consume(), s = t.getTokenStream().LA(1);
    }
  }
  class Ce extends Ae {
    constructor() {
  ...
  const Ne = {
    RecognitionException: Ft,
    NoViableAltException: ee,
    LexerNoViableAltException: Mt,
    InputMismatchException: xe,
    FailedPredicateException: Te,
    DiagnosticErrorListener: me,
    BailErrorStrategy: Ce,
    DefaultErrorStrategy: Ae,
  ...
  class ye {
    constructor(t, e) {
      if (this.name = "<empty>", this.strdata = t, this.decodeToUnicodeCodePoints = e || !1, this._index = 0, this.data = [], this.decodeToUnicodeCodePoints) for (let t = 0; t < this.strdata.length;) {
        ...
        for (let t = 0; t < this.strdata.length; t++) this.data[t] = this.strdata.charCodeAt(t);
      }
    ...
    LA(t) {
      ...
      return e < 0 || e >= this._size ? n.EOF : this.data[e];
    }
    LT(t) {
      return this.LA(t);
    }
  ...
  const ke = require("fs"),
    Le = "undefined" != typeof process && null != process.versions && null != process.versions.node;
  class Oe extends Ie {
    static fromPath(t, e, n) {
      if (!Le) throw new Error("FileStream is only available when running in Node!");
      ke.readFile(t, e, function (t, e) {
        let s = null;
        null !== e && (s = new ye(e, !0)), n(t, s);
      });
    }
    constructor(t, e, n) {
      if (!Le) throw new Error("FileStream is only available when running in Node!");
      super(ke.readFileSync(t, e || "utf-8"), n), this.fileName = t;
    }
  }
  const ve = {
      ...
      fromBlob: function (t, e, n, s) {
        ...
        i.onload = function (t) {
          const e = new ye(t.target.result, !0);
          n(e);
        }, i.onerror = s, i.readAsText(t, e);
      },
      fromBuffer: function (t, e) {
        return new ye(t.toString(e), !0);
      },
  ...
  class Pe extends we {
    ...
    consume() {
      let t = !1;
      if (t = this.index >= 0 && (this.fetchedEOF ? this.index < this.tokens.length - 1 : this.index < this.tokens.length), !t && this.LA(1) === n.EOF) throw "cannot consume EOF";
    ...
    fetch(t) {
      ...
      for (let e = 0; e < t; e++) {
        ...
        if (t.tokenIndex = this.tokens.length, this.tokens.push(t), t.type === n.EOF) return this.fetchedEOF = !0, e + 1;
      }
      return t;
    }
    getTokens(t, e, s) {
      if (void 0 === s && (s = null), t < 0 || e < 0) return null;
      this.lazyInit();
      const i = [];
      e >= this.tokens.length && (e = this.tokens.length - 1);
      for (let r = t; r < e; r++) {
        const t = this.tokens[r];
        if (t.type === n.EOF) break;
        (null === s || s.contains(t.type)) && i.push(t);
      }
      return i;
    }
    LA(t) {
    ...
    nextTokenOnChannel(t, e) {
      ...
      for (; s.channel !== this.channel;) {
        if (s.type === n.EOF) return -1;
        t += 1, this.sync(t), s = this.tokens[t];
      }
      return t;
    }
    ...
    getHiddenTokensToRight(t, e) {
      ...
      const n = this.nextTokenOnChannel(t + 1, Ut.DEFAULT_TOKEN_CHANNEL),
        s = t + 1,
    ...
    getHiddenTokensToLeft(t, e) {
      if (void 0 === e && (e = -1), this.lazyInit(), t < 0 || t >= this.tokens.length) throw t + " not in 0.." + this.tokens.length - 1;
      const n = this.previousTokenOnChannel(t - 1, Ut.DEFAULT_TOKEN_CHANNEL);
    ...
    filterForChannel(t, e, n) {
      ...
      for (let i = t; i < e + 1; i++) {
        ...
        -1 === n ? t.channel !== Ut.DEFAULT_TOKEN_CHANNEL && s.push(t) : t.channel === n && s.push(t);
      }
    ...
    getText(t) {
      this.lazyInit(), this.fill(), t || (t = new m(0, this.tokens.length - 1));
      let e = t.start;
      e instanceof n && (e = e.tokenIndex);
      let s = t.stop;
      if (s instanceof n && (s = s.tokenIndex), null === e || null === s || e < 0 || s < 0) return "";
      s >= this.tokens.length && (s = this.tokens.length - 1);
      let i = "";
      for (let t = e; t < s + 1; t++) {
        const e = this.tokens[t];
        if (e.type === n.EOF) break;
        i += e.text;
      }
      return i;
    }
  ...
  class be extends Pe {
    constructor(t, e) {
      super(t), this.channel = void 0 === e ? n.DEFAULT_CHANNEL : e;
    }
    adjustSeekIndex(t) {
    ...
    getNumberOfOnChannelTokens() {
      ...
      for (let e = 0; e < this.tokens.length; e++) {
        ...
        if (s.channel === this.channel && (t += 1), s.type === n.EOF) break;
      }
      return t;
    }
  }
  ...
  class Fe extends wt {
    constructor(t) {
      super(), this._input = null, this._errHandler = new Ae(), this._precedenceStack = [], this._precedenceStack.push(0), this._ctx = null, this.buildParseTrees = !0, this._tracer = null, this._parseListeners = null, this._syntaxErrors = 0, this.setInputStream(t);
    }
    reset() {
    ...
    matchWildcard() {
      ...
      return t.type > 0 ? (this._errHandler.reportMatch(this), this.consume()) : (t = this._errHandler.recoverInline(this), this.buildParseTrees && -1 === t.tokenIndex && this._ctx.addErrorNode(t)), t;
    }
    getParseListeners() {
    ...
    getATNWithBypassAlts() {
      ...
      if (null === e) {
        const n = new Tt();
        n.generateRuleBypassTransitions = !0, e = new Lt(n).deserialize(t), this.bypassAltsAtnCache[t] = e;
      }
      return e;
    }
    getInputStream() {
    ...
    consume() {
      ...
      t.type !== n.EOF && this.getInputStream().consume();
      const e = null !== this._parseListeners && this._parseListeners.length > 0;
      if (this.buildParseTrees || e) {
        let n;
        n = this._errHandler.inErrorRecoveryMode(this) ? this._ctx.addErrorNode(t) : this._ctx.addTokenNode(t), n.invokingState = this.state, e && this._parseListeners.forEach(function (t) {
          n instanceof b || void 0 !== n.isErrorNode && n.isErrorNode() ? t.visitErrorNode(n) : n instanceof P && t.visitTerminal(n);
        });
      }
      return t;
    }
    ...
    unrollRecursionContexts(t) {
      ...
      if (null !== n && n.length > 0) for (; this._ctx !== t;) this.triggerExitRuleEvent(), this._ctx = this._ctx.parentCtx;else this._ctx = t;
    ...
    isExpectedToken(t) {
      ...
      let r = e.nextTokens(i);
      if (r.contains(t)) return !0;
      if (!r.contains(n.EPSILON)) return !1;
      for (; null !== s && s.invokingState >= 0 && r.contains(n.EPSILON);) {
        const n = e.states[s.invokingState].transitions[0];
        if (r = e.nextTokens(n.followState), r.contains(t)) return !0;
        s = s.parentCtx;
      }
      return !(!r.contains(n.EPSILON) || t !== n.EOF);
    }
    getExpectedTokens() {
    ...
    setTrace(t) {
      t ? (null !== this._tracer && this.removeParseListener(this._tracer), this._tracer = new De(this), this.addParseListener(this._tracer)) : (this.removeParseListener(this._tracer), this._tracer = null);
    }
  }
  ...
  class Be extends M {
    ...
    copyFrom(t) {
      this.parentCtx = t.parentCtx, this.invokingState = t.invokingState, this.children = null, this.start = t.start, this.stop = t.stop, t.children && (this.children = [], t.children.map(function (t) {
        t instanceof Ue && (this.children.push(t), t.parentCtx = this);
      }, this));
    }
    enterRule(t) {}
    exitRule(t) {}
    ...
    getToken(t, e) {
      ...
      for (let n = 0; n < this.children.length; n++) {
        const s = this.children[n];
        if (s instanceof P && s.symbol.type === t) {
          if (0 === e) return s;
          e -= 1;
        }
      }
    ...
    getTokens(t) {
      if (null === this.children) return [];
      {
        ...
        for (let n = 0; n < this.children.length; n++) {
          const s = this.children[n];
          s instanceof P && s.symbol.type === t && e.push(s);
        }
        return e;
      }
    }
  ...
  class Ve {
    constructor(t) {
      this.tokens = t, this.programs = new Map();
    }
    getTokenStream() {
      return this.tokens;
    }
    insertAfter(t, e) {
      let n,
        s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : Ve.DEFAULT_PROGRAM_NAME;
      n = "number" == typeof t ? t : t.tokenIndex;
      let i = this.getProgram(s),
        r = new Ge(this.tokens, n, i.length, e);
      i.push(r);
    }
    insertBefore(t, e) {
      let n,
        s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : Ve.DEFAULT_PROGRAM_NAME;
      n = "number" == typeof t ? t : t.tokenIndex;
      const i = this.getProgram(s),
        r = new Ye(this.tokens, n, i.length, e);
      i.push(r);
    }
    replaceSingle(t, e) {
      let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : Ve.DEFAULT_PROGRAM_NAME;
      this.replace(t, t, e, n);
    }
    replace(t, e, n) {
      let s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : Ve.DEFAULT_PROGRAM_NAME;
      if ("number" != typeof t && (t = t.tokenIndex), "number" != typeof e && (e = e.tokenIndex), t > e || t < 0 || e < 0 || e >= this.tokens.size) throw new RangeError(`replace: range invalid: ${t}..${e}(size=${this.tokens.size})`);
      let i = this.getProgram(s),
        r = new je(this.tokens, t, e, i.length, n);
      i.push(r);
    }
    delete(t, e) {
      let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : Ve.DEFAULT_PROGRAM_NAME;
      void 0 === e && (e = t), this.replace(t, e, null, n);
    }
    getProgram(t) {
      let e = this.programs.get(t);
      return null == e && (e = this.initializeProgram(t)), e;
    }
    initializeProgram(t) {
      const e = [];
    ...
    getText(t) {
      let e,
        s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Ve.DEFAULT_PROGRAM_NAME;
      e = t instanceof m ? t : new m(0, this.tokens.size - 1), "string" == typeof t && (s = t);
      const i = this.programs.get(s);
      let r = e.start,
        o = e.stop;
      if (o > this.tokens.size - 1 && (o = this.tokens.size - 1), r < 0 && (r = 0), null == i || 0 === i.length) return this.tokens.getText(new m(r, o));
      let a = [],
        l = this.reduceToSingleOperationPerIndex(i),
        h = r;
      for (; h <= o && h < this.tokens.size;) {
        let t = l.get(h);
        l.delete(h);
        let e = this.tokens.get(h);
        null == t ? (e.type !== n.EOF && a.push(String(e.text)), h++) : h = t.execute(a);
      }
      if (o === this.tokens.size - 1) for (const t of l.values()) t.index >= this.tokens.size - 1 && a.push(t.text.toString());
      return a.join("");
    }
    reduceToSingleOperationPerIndex(t) {
      for (let e = 0; e < t.length; e++) {
        let n = t[e];
        if (null == n) continue;
        if (!(n instanceof je)) continue;
        let s = n,
          i = this.getKindOfOps(t, Ye, e);
        for (let e of i) e.index === s.index ? (t[e.instructionIndex] = void 0, s.text = e.text.toString() + (null != s.text ? s.text.toString() : "")) : e.index > s.index && e.index <= s.lastIndex && (t[e.instructionIndex] = void 0);
        let r = this.getKindOfOps(t, je, e);
        for (let e of r) {
          if (e.index >= s.index && e.lastIndex <= s.lastIndex) {
            t[e.instructionIndex] = void 0;
            continue;
          }
          let n = e.lastIndex < s.index || e.index > s.lastIndex;
          if (null != e.text || null != s.text || n) {
            if (!n) throw new Error(`replace op boundaries of ${s} overlap with previous ${e}`);
          } else t[e.instructionIndex] = void 0, s.index = Math.min(e.index, s.index), s.lastIndex = Math.max(e.lastIndex, s.lastIndex);
        }
      }
      for (let e = 0; e < t.length; e++) {
        let n = t[e];
        if (null == n) continue;
        if (!(n instanceof Ye)) continue;
        let s = n,
          i = this.getKindOfOps(t, Ye, e);
        for (let e of i) e.index === s.index && (e instanceof Ge ? (s.text = this.catOpText(e.text, s.text), t[e.instructionIndex] = void 0) : e instanceof Ye && (s.text = this.catOpText(s.text, e.text), t[e.instructionIndex] = void 0));
        let r = this.getKindOfOps(t, je, e);
        for (let n of r) if (s.index !== n.index) {
          if (s.index >= n.index && s.index <= n.lastIndex) throw new Error(`insert op ${s} within boundaries of previous ${n}`);
        } else n.text = this.catOpText(s.text, n.text), t[e] = void 0;
      }
      let e = new Map();
      for (let n of t) if (null != n) {
        if (null != e.get(n.index)) throw new Error("should only be one op per index");
        e.set(n.index, n);
      }
      return e;
    }
    catOpText(t, e) {
      let n = "",
        s = "";
      return null != t && (n = t.toString()), null != e && (s = e.toString()), n + s;
    }
    getKindOfOps(t, e, n) {
      return t.slice(0, n).filter(t => t && t instanceof e);
    }
  }
  var ze, qe, He;
  ze = Ve, He = "default", (qe = function (t) {
    var e = function (t, e) {
  ...
  }(qe = "DEFAULT_PROGRAM_NAME")) in ze ? Object.defineProperty(ze, qe, {
    value: He,
    enumerable: !0,
    configurable: !0,
    writable: !0
  ...
  class Ke {
    constructor(t, e, n, s) {
      this.tokens = t, this.instructionIndex = n, this.index = e, this.text = void 0 === s ? "" : s;
    }
    toString() {
  ...
  class Ye extends Ke {
    ...
    execute(t) {
      return this.text && t.push(this.text.toString()), this.tokens.get(this.index).type !== n.EOF && t.push(String(this.tokens.get(this.index).text)), this.index + 1;
    }
  }
  class Ge extends Ye {
    constructor(t, e, n, s) {
  ...
  const We = {
    ...
    LL1Analyzer: W,
    Utils: Re,
    TokenStreamRewriter: Ve
  };
  var $e = exports;
  for (var Xe in e) $e[Xe] = e[Xe];
  e.__esModule && Object.defineProperty($e, "__esModule", {
    value: !0
  });
})();