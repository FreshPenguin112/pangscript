...
class LuaParser extends _antlr.default.Parser {
  ...
  static ruleNames = ["start_", "chunk", "block", "statement", "attnamelist", "attrib", "retstatement", "label", "funcname", "varlist", "namelist", "explist", "exp", "var", "prefixexp", "functioncall", "args", "functiondef", "funcbody", "parlist", "tableconstructor", "fieldlist", "field", "fieldsep", "number", "string"];
  constructor(input) {
    super(input);
