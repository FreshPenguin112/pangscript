...
class LuaParser extends _antlr.default.Parser {
  ...
  static literalNames = [null, "';'", "'='", "'break'", "'goto'", "'do'", "'end'", "'while'", "'repeat'", "'until'", "'if'", "'then'", "'elseif'", "'else'", "'for'", "','", "'in'", "'function'", "'local'", "'<'", "'>'", "'return'", "'continue'", "'::'", "'nil'", "'false'", "'true'", "'.'", "'~'", "'-'", "'#'", "'('", "')'", "'not'", "'<<'", "'>>'", "'&'", "'//'", "'%'", "':'", "'<='", "'>='", "'and'", "'or'", "'+'", "'*'", "'{'", "'}'", "'['", "']'", "'=='", "'..'", "'|'", "'^'", "'/'", "'...'", "'~='"];
  static symbolicNames = [null, "SEMI", "EQ", "BREAK", "GOTO", "DO", "END", "WHILE", "REPEAT", "UNTIL", "IF", "THEN", "ELSEIF", "ELSE", "FOR", "COMMA", "IN", "FUNCTION", "LOCAL", "LT", "GT", "RETURN", "CONTINUE", "CC", "NIL", "FALSE", "TRUE", "DOT", "SQUIG", "MINUS", "POUND", "OP", "CP", "NOT", "LL", "GG", "AMP", "SS", "PER", "COL", "LE", "GE", "AND", "OR", "PLUS", "STAR", "OCU", "CCU", "OB", "CB", "EE", "DD", "PIPE", "CARET", "SLASH", "DDD", "SQEQ", "NAME", "NORMALSTRING", "CHARSTRING", "LONGSTRING", "INT", "HEX", "FLOAT", "HEX_FLOAT", "COMMENT", "WS", "NL", "SHEBANG"];
  static ruleNames = ["start_", "chunk", "block", "statment", "attnamelist", "attrib", "retstatment", "label", "funcname", "varlist", "namelist", "explist", "exp", "var", "prefixexp", "functioncall", "args", "functiondef", "funcbody", "parlist", "tableconstructor", "fieldlist", "field", "fieldsep", "number", "string"];
  constructor(input) {
    super(input);
  ...
  statment() {
    ...
    this.enterRule(localctx, 6, LuaParser.RULE_statment);
    var _la = 0;
    try {
      this.state = 147;
      this._errHandler.sync(this);
  ...
  retstatment() {
    let localctx = new RetstatmentContext(this, this._ctx, this.state);
    this.enterRule(localctx, 12, LuaParser.RULE_retstatment);
    var _la = 0;
    try {
      this.enterOuterAlt(localctx, 1);
      this.state = 170;
...
LuaParser.RULE_statment = 3;
LuaParser.RULE_attnamelist = 4;
LuaParser.RULE_attrib = 5;
LuaParser.RULE_retstatment = 6;
...
class BlockContext extends _antlr.default.ParserRuleContext {
  ...
  retstatment() {
    return this.getTypedRuleContext(RetstatmentContext, 0);
  }
  enterRule(listener) {
    if (listener instanceof _LuaParserListener.default) {
...
class StatmentContext extends _antlr.default.ParserRuleContext {
  constructor(parser, parent, invokingState) {
    if (parent === undefined) {
      parent = null;
    }
    ...
    super(parent, invokingState);
    this.parser = parser;
    this.ruleIndex = LuaParser.RULE_statment;
  }
  SEMI() {
  ...
  enterRule(listener) {
    if (listener instanceof _LuaParserListener.default) {
      listener.enterStatment(this);
    }
  }
  exitRule(listener) {
    if (listener instanceof _LuaParserListener.default) {
      listener.exitStatment(this);
    }
  }
  accept(visitor) {
    if (visitor instanceof _LuaParserVisitor.default) {
...
class RetstatmentContext extends _antlr.default.ParserRuleContext {
  constructor(parser, parent, invokingState) {
    if (parent === undefined) {
      parent = null;
    }
    ...
    super(parent, invokingState);
    this.parser = parser;
    this.ruleIndex = LuaParser.RULE_retstatment;
  }
  RETURN() {
  ...
  enterRule(listener) {
    if (listener instanceof _LuaParserListener.default) {
      listener.enterRetstatment(this);
    }
  }
  exitRule(listener) {
    if (listener instanceof _LuaParserListener.default) {
      listener.exitRetstatment(this);
    }
  }
  accept(visitor) {
    if (visitor instanceof _LuaParserVisitor.default) {
      return visitor.visitRetstatment(this);
    } else {
      return visitor.visitChildren(this);
    }
  }
...
LuaParser.StatmentContext = StatmentContext;
LuaParser.AttnamelistContext = AttnamelistContext;
LuaParser.AttribContext = AttribContext;
LuaParser.RetstatmentContext = RetstatmentContext;
