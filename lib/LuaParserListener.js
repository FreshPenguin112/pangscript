...
class LuaParserListener extends _antlr.default.tree.ParseTreeListener {
  ...
  // Enter a parse tree produced by LuaParser#retstatement.
  enterRetstatement(ctx) {}

  // Exit a parse tree produced by LuaParser#retstatement.
  exitRetstatement(ctx) {}
  ...
  // Enter a parse tree produced by LuaParser#returntype.
  enterReturntype(ctx) {}

  // Exit a parse tree produced by LuaParser#returntype.
  exitReturntype(ctx) {}
